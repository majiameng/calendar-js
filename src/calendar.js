...
(function () {
    ...
    function createTable(options, e) {
        ...
        /* 创建时间表格 */
        var datetable = new DateTable(Y, M,options.begin_year,options.end_year, e);
        datetable.create();
        /* 设置样式 */
    ...
    /* 定义创建时间表格函数 */
    var DateTable = function (Y, M,begin_year,end_year, e) {
        var temp = null;
        this.Y = Y;
        this.M = M;
    ...
    DateTable.prototype.leftHead = function () {
        ...
        for (var i = this.begin_year; i <= this.end_year; i++) this.html += "<option value=\"" + i + "\">" + i + "</option>";
        this.html += "</select>";
